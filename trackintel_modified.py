...
def extract_staypoints_maxtime(positionfixes, method='sliding',
                       dist_threshold=50, time_threshold=5 * 60, epsilon=100, timemax_threshold=12 * 3600,
        ...
        for user_id_this in positionfixes['user_id'].unique():
            ...
            while i < num_pfs:
                ...
                while j < num_pfs:
                    ...
                    if dist > dist_threshold or (delta_t.total_seconds() > timemax_threshold):
